...
# 定义当前版本号
CURRENT_VERSION = "1.87.2.2"#定义CURRENT_VERSION变量
...
def check_version_update():
    ...
    try:
        ...
        if latest_version and latest_version != CURRENT_VERSION:#如果latest_version和CURRENT_VERSION不相等
            print("\n")
            print(" ╔═══════════════════════════════════════════════════════════════╗")#打印标题
            print(" ║                                                               ║")#打印标题
            print(" ║                   ⚠️ 重要版本更新提醒 ⚠️                       ║")#打印标题
            print(" ║                                                               ║")#打印标题
            print(" ╠═══════════════════════════════════════════════════════════════╣")#打印标题
            print(f"║  当前版本: {CURRENT_VERSION}                                   ║")#打印当前版本
            print(f"║  最新版本: {latest_version}                                    ║")#打印最新版本
            print(" ║                                                               ║")#打印标题
            print(" ║  强烈建议更新到最新版本以获取新功能和重要修复！                   ║")#打印标题
            print(" ║                                                               ║")#打印标题
            print(" ║  请访问以下链接获取更新:                                        ║")#打印标题
            print(" ║  https://github.com/ikdxhz/Python-package-manager/            ║")#打印标题
            print(" ║                                                               ║")#打印标题
            print(" ╚═══════════════════════════════════════════════════════════════╝")#打印标题
            print("\n")#打印标题
            return False
